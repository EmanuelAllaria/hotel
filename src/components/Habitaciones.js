...
import imagen1 from "../img/img-hotel/hotel-imagenes (24).jpg";
import imagen2 from "../img/img-hotel/hotel-imagenes (19).jpg";
import imagen3 from "../img/img-hotel/hotel-imagenes (14).jpg";
import imagen4 from "../img/img-hotel/hotel-imagenes (13).jpg";
import imagen5 from "../img/img-hotel/hotel-imagenes (12).jpg";
import imagen6 from "../img/img-hotel/hotel-imagenes (9).jpg";
import imagen7 from "../img/img-hotel/hotel-imagenes (7).jpg";
import imagen8 from "../img/img-hotel/hotel-imagenes (15).jpg";
      ...
      <div className="container-cards">
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p className="card-text text-muted">
              Cálida y funcional para 1-2 huéspedes. Baño privado, TV y WiFi.
            </p>
        ...
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p className="card-text text-muted">
              Más espacio y confort. Sommier queen, frigobar y escritorio.
            </p>
            <a href="#booking" className="btn btn-primary">
              Reservar
            </a>
        ...
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p className="card-text text-muted">
              Ambiente premium con living, vista destacada y amenities
              exclusivos.
            </p>
            <a href="#booking" className="btn btn-primary">
              Reservar
